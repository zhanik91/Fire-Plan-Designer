// Security Warning: This data is for development/demonstration purposes only.
// In a real production environment, never commit user credentials to the codebase.
// Use environment variables or a secure secret manager.

export const SEED_USERS_DATA = `DISTRICT DISTRICT ДЧС г.Аст УЧС район dist_g_ast A_s6-fKkh
